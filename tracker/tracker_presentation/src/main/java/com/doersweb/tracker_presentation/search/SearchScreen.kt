...
import com.doersweb.tracker_presentation.search.uicomponent.SearchTextField
import com.doersweb.tracker_presentation.search.uicomponent.TrackableFoodItem
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            items(state.trackableFoods) { food->
                TrackableFoodItem(
                    ...
                    onAmountChange = {
                        viewModel.onEvent(SearchEvent.OnAmountChangeForTrackableFood(
                            food.food, it
                        ))
                    },
                    onTrack = {
